...
def test_audit_log():
    ...
    if len(entries) == 1 and entries[0].payload["test"] == "data":
        print("✓ AuditLog working correctly")
        return True
    else:
        print("✗ AuditLog test failed")
        return False
...
def test_project_state():
    ...
    if loaded.outline == "Test outline":
        print("✓ ProjectState working correctly")
        return True
    else:
        print("✗ ProjectState test failed")
        return False
...
def test_agent_factory():
    ...
    if agent.name == "plot_architect":
        ...
        print("✗ AgentFactory test failed")
        return False
